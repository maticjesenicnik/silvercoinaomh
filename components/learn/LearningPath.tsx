      ...
      <div className="group relative h-full">
        ...
        <div className="flex h-full flex-col rounded-xl border border-white/10 bg-white/5 p-6 backdrop-blur-sm transition-all duration-300 hover:bg-white/10 hover:scale-105">
          ...
          <div className="mb-4 flex items-center gap-4">
            ...
            <div className="flex h-8 w-8 items-center justify-center rounded-full bg-blue-600 text-sm font-bold text-white">{number}</div>
          </div>

          <h4 className="mb-3 text-lg font-bold text-white group-hover:text-blue-300 transition-colors">{title}</h4>
          <p className="flex-1 text-sm text-gray-300 leading-relaxed">{description}</p>
        </div>
      </div>
    </div>
  )
    ...
    <AnimatedSection delay={600}>
      <div className="mb-16">
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto max-w-2xl text-gray-300">Follow this recommended path to master Silver Coin: Age of Monster Hunters step by step.</p>
        </div>
