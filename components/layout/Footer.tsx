      ...
      <div className="container mx-auto px-4 lg:px-6 py-6">
        <div className="flex flex-col lg:flex-row justify-between items-center gap-6">
          ...
          <div className="flex items-center gap-4">
            <span className="text-sm text-gray-400 font-medium hidden lg:block">Partners:</span>
            <div className="flex items-center gap-4">
              <a 
          ...
          <div className="flex flex-col items-center gap-3">
            <div className="flex gap-2">
              {socialsData.socials.map((social: any, index: number) => (
                <a
                  key={index}
                  className="p-2 rounded-lg bg-white/5 hover:bg-white/15 transition-all duration-200 hover:scale-110"
                  href={social.url}
                  target="_blank"
                  rel="noreferrer"
