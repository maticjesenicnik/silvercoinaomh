      ...
      <div className="mt-24 text-center">
        <div className="mx-auto max-w-2xl">
          ...
          <p className="mb-8 text-base text-gray-300 leading-relaxed">
            Every piece of artwork in Silver Coin: Age of Monster Hunters has been carefully crafted to immerse you in the world of Atosia. Discover the rich
            backstories, unique abilities, and compelling lore behind each character and monster.
          </p>
