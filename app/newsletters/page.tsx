      ...
      <div className="container mx-auto px-4 pb-16 lg:px-6">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          {filteredNewsletters.map((newsletter: any, index: number) => (
            <article key={index} className="group h-full overflow-hidden rounded-xl border border-white/10 bg-white/5 backdrop-blur-sm transition-all duration-300 hover:scale-105 hover:bg-white/10 hover:shadow-2xl">
